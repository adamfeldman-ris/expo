...
public class CalendarModule extends ExportedModule implements ModuleRegistryConsumer {
  ...
  @ExpoMethod
  public void saveCalendarAsync(final Arguments details, final Promise promise) {
    if (!checkPermissions(promise)) {
      return;
    }
    try {
  ...
  @ExpoMethod
  public void saveEventAsync(final Arguments details, final Arguments options, final Promise promise) {
    if (!checkPermissions(promise)) {
      return;
    }
    try {
  ...
  @ExpoMethod
  public void deleteEventAsync(final Arguments details, final Arguments options, final Promise promise) {
    if (!checkPermissions(promise)) {
      return;
    }
    try {
  ...
  @ExpoMethod
  public void saveAttendeeForEventAsync(final Arguments details, final String eventID, final Promise promise) {
    if (!checkPermissions(promise)) {
      return;
    }
    try {
  ...
  private int saveCalendar(Arguments details) throws Exception {
    ContentResolver cr = mContext.getContentResolver();
    ...
    if (details.containsKey("id")) {
      ...
      Arguments source = details.getArguments("source");
  ...
  private int saveEvent(Arguments details) throws ParseException, SecurityException {
    String dateFormat = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'";
    SimpleDateFormat sdf = new SimpleDateFormat(dateFormat);
    sdf.setTimeZone(TimeZone.getTimeZone("GMT"));
    ...
    if (details.containsKey("startDate")) {
      ...
      try {
        if (startDate instanceof String) {
          ...
          eventValues.put(CalendarContract.Events.DTSTART, (long) startDate);
        }
      } catch (ParseException e) {
        Log.e(TAG, "error", e);
        throw e;
    ...
    if (details.containsKey("endDate")) {
      ...
      try {
        if (endDate instanceof String) {
          ...
          eventValues.put(CalendarContract.Events.DTEND, (long) endDate);
        }
      } catch (ParseException e) {
        Log.e(TAG, "error", e);
        throw e;
    ...
    if (details.containsKey("recurrenceRule")) {
      Arguments recurrenceRule = details.getArguments("recurrenceRule");
      ...
      if (recurrenceRule.containsKey("frequency")) {
        ...
        if (recurrenceRule.containsKey("endDate")) {
          ...
          if (endDateObj instanceof String) {
            ...
            calendar.setTimeInMillis((long) endDateObj);
  ...
  private boolean removeEvent(Arguments details) throws ParseException, SecurityException {
    int rows = 0;
    ...
    if (!details.containsKey("instanceStartDate")) {
      ...
      try {
        if (instanceStartDate instanceof String) {
          ...
          exceptionValues.put(CalendarContract.Events.ORIGINAL_INSTANCE_TIME, (long) instanceStartDate);
        }
      } catch (ParseException e) {
        Log.e(TAG, "error", e);
        throw e;
  ...
  private int saveAttendeeForEvent(Arguments details, String eventID) throws Exception, SecurityException {
    ContentResolver cr = mContext.getContentResolver();
